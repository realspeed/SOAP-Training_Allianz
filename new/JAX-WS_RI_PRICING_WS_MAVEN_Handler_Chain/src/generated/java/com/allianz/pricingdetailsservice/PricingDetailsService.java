 ...
 * 2018-08-04T23:03:14.325+05:30
 * Generated source version: 3.1.11.fuse-000281-redhat-3
 * 
 */
@WebServiceClient(name = "PricingDetailsService", 
                  wsdlLocation = "file:/E:/Dhananjaya-realspeed/SOAP-Training_Allianz/new/JAX-WS_RI_PRICING_WS_MAVEN_Handler_Chain/src/main/webapp/WEB-INF/PricingDetailsService.wsdl",
...
public class PricingDetailsService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Dhananjaya-realspeed/SOAP-Training_Allianz/new/JAX-WS_RI_PRICING_WS_MAVEN_Handler_Chain/src/main/webapp/WEB-INF/PricingDetailsService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PricingDetailsService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/Dhananjaya-realspeed/SOAP-Training_Allianz/new/JAX-WS_RI_PRICING_WS_MAVEN_Handler_Chain/src/main/webapp/WEB-INF/PricingDetailsService.wsdl");
        }
        WSDL_LOCATION = url;
    }
